    ...
    useEffect(() => {
        ...
        if (data && data?.length > 0) {
            ...
            function getDataDuration(user) {
                // separates the string in hours, minutes
            ...
            function userArrayToObject(user) {
                ...
                dataObjectMy = user.Days.reduce((acc, element) => {return {...acc,  [element.Date ] : element.durationMs}}, {id: user?.id, Fullname: user?.Fullname, Total: user?.Total} )
                return dataObjectMy
            }
